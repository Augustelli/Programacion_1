...
#     usuario= db.relationship('Usuario', back_populates='usuario_contrasegna', uselist=False, cascade='all, delete-orphan')
#     login=db.relationship('Login_usuario', back_populates='login_usuario_contrasegna',uselist=False,cascade='all, delete-orphan')
