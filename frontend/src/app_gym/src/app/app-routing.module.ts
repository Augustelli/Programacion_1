...
import { authsessionGuardToken, authsessionGuardTokenAdminUser } from './guards/authsession.guard';
...
const routes: Routes = [
  ...
  {path:'usuarios',component:UsuariosComponent, canActivate:[authsessionGuardToken]},
